...
import { BlockUser, getAccount, cancelRequest as handleCancelation, follow as handleFollow, unfollow as handleUnfollow } from "../../../helpers/api"
    ...
    useEffect(() => {
        ...
        getAccount(id)
            .then(response => {
                ...
                setIsBlocked((response.payload as IAccount).connection.didIBlock)
            })
            ...
            <div className="col-md-8 col-lg-8">
                <div className="d-flex flex-column">
                    ...
                    <div className="p-3 bg-black text-white">
                        ...
                        <button onClick={handleBlock} className="btn btn-primary btn-sm">
                            {
                                isBlocked ?
                                    "unblock" :
                                    "block"
